...
async def get_url(cords):
    ...
    return f"https://maps.googleapis.com/maps/api/staticmap?path=color:0x0000ff80|weight:5|{lon1},{lat1}|\
       {lon2},{lat2}&markers=icon:https://storage.yandexcloud.net/test-geoguessr/correct_marker.png|{lon1},{lat1}&markers=icon:https://\
            storage.yandexcloud.net/test-geoguessr/marker.png|{lon2},{lat2}|&size=400x400&key=AIzaSyB90M6YMN89duMBupapc6x7_K8gRNGw7sk"
