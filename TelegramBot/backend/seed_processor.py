...
def coordinates_and_landmark_from_seed_easy_mode(seed):
    ...
    match rand_case:
        ...
        case 6:
            x, y = 48.857123452197335, 2.295837686783114
        case 7:
            x, y = 40.75858076544584, -73.98505242333238
        case 8:
            x, y = 40.688855249745544, -74.04388797764464
        case 9:
            x, y = 29.977174759757176, 31.134552867756888
        case 10:
            x, y = 37.80616041299968, -122.4746241078285
        case 11:
            x, y = 43.87851986592188, -103.45779070684608
        case 12:
            x, y = 41.890454311204074, 12.493860380817457
        case 13:
            x, y = 43.72316754501737, 10.39716762885059
        case 14:
            x, y = -13.162214498987222, -72.54589247636864
        case 15:
            x, y = 48.86096323884715, 2.3337441880873055
        case 16:
            x, y = 43.08600796537896, -79.07266272129134
        case 17:
            x, y = 36.10077753719524, -112.08918849006676
        case 18:
            x, y = 39.916580960201266, 116.39744145591825
        case 19:
            x, y = 48.85333343853748, 2.348953010565631
        case 20:
            x, y = -33.85844105777454, 151.21472452881036
        case 21: # Версальский 
            x, y = 48.804964962132345, 2.119841811718045
        case 22:
            x, y = 51.50634308140983, -0.074117921397408
        case 23:
            x, y = 25.19735015497911, 55.27336470035292
        case 24:
            x, y = 50.08632281425151, 14.41285778387527
        case 25:
            x, y = 31.47685816399695, 35.39765599249518
        case 26:
            x, y = 31.77661645701152, 35.23405395820514
        case 27:
            x, y = 35.26196634324321, 138.86401239351696
        case 28:
            x, y = 41.89910583208614, 12.476881646488733
        case 29:
            x, y = 37.97119386746694, 23.726025693797528
        case 30:
            x, y = 38.89739088845979, -77.03645473815097
        case 31:
            x, y = 27.17333091234201, 78.04211680744979
        case 32:
            x, y = 40.749081566810275, 14.484600494857638
        case 33:
            x, y = 45.43428658694612, 12.339331517912688
        case 34:
            x, y = 51.50160714447481, -0.1413019916921259
        case 35:
            x, y = 41.90236612077546, 12.458473496903943
        case 36:
            x, y = 34.12750525404751, -118.32712922879942
        case 37:
            x, y = 19.69300278815871, -98.84584227505634
        case 38:
            x, y = 41.00735431193185, 28.97837121116076
        case 39:
            x, y = -22.951923525762172, -43.210493341081275
        case 40:
            x, y = 13.412469995822102, 103.86486523261715
        case 41:
            x, y = 36.14542499760043, -5.341464336773421
        case 42:
            x, y = 41.40322523833751, 2.173582503343521
        case 43:
            x, y = 25.140171161361373, 55.18679029032763
        case 44:
            x, y = 7.827948527277889, 98.31330884063624
        case 45:
            x, y = 43.6386198028266, -79.38736006756923
        case 46:
            x, y = 30.328948619845132, 35.44240209917711
