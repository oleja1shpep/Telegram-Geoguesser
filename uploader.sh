...
yc serverless function version create \
    ...
    --memory 256MB \
    --environment FOLDER_ID=$FOLDER_ID,TOKEN_BOT=$TOKEN_BOT,TOKEN_STATIC=$TOKEN_STATIC,DB_USER=$DB_USER,DB_HOST=$DB_HOST,DB_PASS=$DB_PASS,DB_NAME=$DB_NAME,URL_SITE=$URL_SITE,YAGPT_APIKEY=$YAGPT_APIKEY,GEOCODER_APIKEY=$GEOCODER_APIKEY\
